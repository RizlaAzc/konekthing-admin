                        ...
                        <table id="datatablesSimple">
                            <thead>
                                <tr style="background-color:#B0C4DE;">
                                    ...
                                    <th class="text-center" width="240">Nama Project</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center" style="vertical-align: middle;"><?= substr($row->nama_project, 0, 30) ?><a>...</a></td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Form Tambah Handle Pekerjaan Our Team</h1>
