        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    Blog Tables<button type="button" class="btn btn-primary" style="float: right;" data-bs-toggle="modal" data-bs-target="#tambahModal">
                        Tambah Blog
                    </button>
                    <div class="btn-group" style="float: right; margin-right: 5px;">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?= base_url('blog/excel') ?>">Excel</a></li>
                            <li><a class="dropdown-item" href="<?= base_url('blog/pdf') ?>">Pdf</a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;"><?= substr($row->judul, 0, 67) ?><a>...</a></td>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;"><a href="<?= base_url('blog/edit_blog/') . $row->id ?>"><i class="fa-solid fa-pen-to-square" style="margin-right: 7px;"></i></a>|<?php if ($this->session->userdata('role_id') == 2) { ?><a href="<?= base_url('blog/fungsi_hapus/') . $row->id ?>"><i class="fa-solid fa-trash-can" style="margin-left: 7px; margin-right: 7px;"></i></a>|<?php } ?><a href="<?= base_url('blog/detail_blog/') . $row->id ?>"><i class="fa-solid fa-circle-info" style="margin-left: 7px;"></i></a><a href="<?= base_url('blog/fitur/') . $row->id ?>" class="btn btn-primary mt-2">Fitur Blog</a></td>
                                </tr>
                            <?php
                            }
                            ?>
