                        ...
                        <tr>
                            <form class="row g-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress" name="judul" value="<?php echo $queryBlgDetail->judul ?>" readonly>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="url" value="<?php echo $queryBlgDetail->url ?>" readonly>
                                </div>
                                <div class="col-md-6">
