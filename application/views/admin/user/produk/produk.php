                ...
                <div class="card-header">
                    ...
                    <div class="btn-group" style="float: right; margin-right: 5px;">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?= base_url('produk/excel') ?>">Excel</a></li>
                            <li><a class="dropdown-item" href="<?= base_url('produk/pdf') ?>">Pdf</a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;"><a href="<?= base_url('produk/edit_produk/') . $row->id ?>"><i class="fa-solid fa-pen-to-square" style="margin-right: 7px;"></i></a>|<?php if ($this->session->userdata('role_id') == 2) { ?><a href="<?= base_url('produk/fungsi_hapus/') . $row->id ?>"><i class="fa-solid fa-trash-can" style="margin-left: 7px; margin-right: 7px;"></i></a>|<?php } ?><a href="<?= base_url('produk/detail_produk/') . $row->id ?>"><i class="fa-solid fa-circle-info" style="margin-left: 7px;"></i></a><a href="<?= base_url('produk/fitur/') . $row->id ?>" class="btn btn-primary mt-2">Fitur Produk</a></td>
                                </tr>
                            <?php
                            }
                            ?>
