        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    SubFitur Produk Tables<button type="button" class="btn btn-primary" style="float: right;" data-bs-toggle="modal" data-bs-target="#tambahModal">
                        Tambah SubFitur
                    </button>
                    <div class="btn-group" style="float: right; margin-right: 5px;">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?= base_url('produk/excel_subfitur/' . $id_fitur . '/' . $id_produk) ?>">Excel</a></li>
                            <li><a class="dropdown-item" href="<?= base_url('produk/pdf_subfitur/' . $id_fitur . '/' . $id_produk) ?>">Pdf</a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
