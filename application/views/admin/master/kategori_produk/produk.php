                ...
                <div class="card-header">
                    ...
                    <div class="btn-group" style="float: right; margin-right: 5px;">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?= base_url('kategori_produk/excel') ?>">Excel</a></li>
                            <li><a class="dropdown-item" href="<?= base_url('kategori_produk/pdf') ?>">Pdf</a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table id="datatablesSimple">
                        <thead>
                            <tr style="background-color:#B0C4DE;">
                                ...
                                <th class="text-center" width="800">Nama Kategori</th>
